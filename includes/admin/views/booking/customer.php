...
<script type="text/x-template" id="tmpl-admin-booking-customer">
    <div id="booking-customer" class="postbox">
        ...
        <h2 class="hndle"><span><?php _e( 'Customer Information', 'wp-hotel-booking' ); ?></span></h2>
        <div class="inside">
            ...
            <div class="booking-notes">
                ...
                <textarea name="content" id="_hb_customer_notes" rows="5"
...
<script type="text/javascript">
    ...
    (function (Vue, $store) {
        ...
        Vue.component('wphb-booking-customer', {
            template: '#tmpl-admin-booking-customer'
        });
