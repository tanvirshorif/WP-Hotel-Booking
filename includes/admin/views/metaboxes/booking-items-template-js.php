        ...
        <form name="booking-room-item" class="booking-room-item">
            ...
            <div class="section_line">
                <# if ( typeof data.post_type === 'undefined' || data.post_type === 'hb_room' ) { #>
                    ...
                    <div class="section">
                        <input type="text" name="check_in_date" class="check_in_date" value="{{ data.check_in_date }}"
                               placeholder="<?php esc_attr_e( 'Check in', 'wp-hotel-booking' ); ?>"/>
                        <input type="hidden" name="check_in_date_timestamp" value="{{ data.check_in_date_timestamp }}"/>
                        <input type="text" name="check_out_date" class="check_out_date"
                               value="{{ data.check_out_date }}"
                               placeholder="<?php esc_attr_e( 'Check out', 'wp-hotel-booking' ); ?>"/>
                        <input type="hidden" name="check_out_date_timestamp"
                               value="{{ data.check_out_date_timestamp }}"/>
                    </div>
                    <# } #>
                        <div class="section">
            ...
            <# if ( typeof data.sub_items !== 'undefined' ) { #>
                                ...
                                <li>
                                        ...
                                        <label>
                                            <# if ( item.selected === true ) { #>
                                                <input type="checkbox" name="sub_items[{{ item.ID }}][checked]"
                                                       checked/>
                                                <input type="hidden" name="sub_items[{{ item.ID }}][order_item_id]"
                                    ...
                                    <# if ( item.respondent === 'number' ) { #>
                                        <div class="section">
                                            ...
                                            <input name="sub_items[{{ item.ID }}][qty]" type="number" step="1" min="0"
                                                   value="{{ item.qty }}"/>
                                        </div>
                                        <# } else { #>
                                            <input name="sub_items[{{ item.ID }}][qty]" type="hidden"
                                                   value="{{ item.qty }}"/>
                                            <# } #>
                                </li>
                                <# } #>
                ...
                <# } #>
                    ...
                    <div class="form_footer">
                        ...
                        <# if ( typeof data.post_type === 'undefined' || data.post_type === 'hb_room' ) { #>
                            <a href="#"
                               class="button check_available{{ data.class }}"><?php _e( 'Check Available', 'wp-hotel-booking' ); ?></a>
                            <# } #>
                                ...
                                <button type="submit"
                                        class="button button-primary hb_form_submit"><?php _e( 'Add', 'wp-hotel-booking' ); ?></button>
                    </div>
        </form>
    </div>
                                ...
                                <li data-price="{{data.extra[_extra].amount_singular}}">
                                    <div class="hb_extra_optional_right">
                                        <input type="checkbox"
                                               ...
                                               id="<?php echo esc_attr( 'hb-ex-room-{{data.product_id}}-{{_extra}}' ) ?>"
                                        />
                                    </div>
