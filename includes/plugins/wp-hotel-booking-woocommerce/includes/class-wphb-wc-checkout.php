...
/**
 * WP Hotel Booking Woocommerce Checkout class.
 *
 * @class       WPHB_WC_Checkout
 * @version     2.0
...
class_exists( 'WPHB_Checkout' ) || exit;


if ( ! class_exists( 'WPHB_WC_Checkout' ) ) {
	 ...
	 * @since 2.0
	 */
	class WPHB_WC_Checkout extends WPHB_Checkout {

		/**
		 * WPHB_WC_Checkout constructor.
		 *
		 * @since 2.0
		 */
		...
		/**
		 * WooCoommerce hook create new order.
		 *
		 * @since 2.0
		 *
		 * @param $order_id
		...
		/**
		 * Create WP Hotel Booking booking.
		 *
		 * @since 2.0
		 *
		 * @param null $order
		...
		/**
		 * Woocommerce transaction object.
		 *
		 * @since 2.0
		 *
		 * @param $transaction
		...
		public function woo_transaction_object( $transaction, $order ) {
			...
			$transaction->booking_info['_hb_description'] = $order->customer_message ? $order->customer_message : '';
			...
			$transaction->booking_info['_hb_addition_information'] = $order->customer_message ? $order->customer_message : '';
