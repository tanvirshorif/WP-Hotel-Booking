                    ...
                    <div class="tp_extra_form_fields">
                        ...
                        <div class="price">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="<?php esc_attr_e( 'Package', 'wp-hb-extra' ) ?>"/>
                        </div>
                        <div class="type">
                        ...
                        <div class="remove">
                            <a data-id="<?php echo esc_attr( $post->ID ); ?>"
                               class="button remove_button"><?php esc_attr_e( 'Remove', 'wp-hb-extra' ); ?></a>
                        </div>
                    </div>
        ...
        <div class="tp_extra_form_fields">
            ...
            <div class="desc">
                ...
                <textarea name="<?php echo esc_attr( $field_name ) ?>[{{ data.id }}][desc]"
                          placeholder="<?php esc_attr_e( 'Enter description here', 'wp-hb-extra' ) ?>"></textarea>
            </div>
            <div class="price">
                <h4><?php _e( 'Price', 'wp-hb-extra' ); ?></h4>
                <input type="number" step="any" name="<?php echo esc_attr( $field_name ); ?>[{{ data.id }}][price]"
                       value="" placeholder="<?php echo esc_attr( '10.5' ) ?>"/>
                <span>/</span>
                <input type="text" name="<?php echo esc_attr( $field_name ); ?>[{{ data.id }}][respondent_name]"
                       value="" placeholder="<?php esc_attr_e( 'Package', 'wp-hb-extra' ) ?>"/>
            </div>
            <div class="type">
                <h4><?php _e( 'Price Type', 'wp-hb-extra' ); ?></h4>
