...
/**
 * WP Hotel Booking latest reviews widget class.
 *
 * @class       HB_Widget_Lastest_Reviews
 * @version     2.0
...
if ( ! class_exists( 'HB_Widget_Lastest_Reviews' ) ) {
	 ...
	 * @since 2.0
	 */
	class HB_Widget_Lastest_Reviews extends WPHB_Abstract_Widget {

		/**
		 * @var string
		 */
		protected $widget_id = 'hb_widget_lastest_reviews';
		...
		public function __construct() {
			$this->widget_title       = __( 'HB Rooms Latest Reviews', 'wp-hotel-booking' );
			$this->widget_description = __( 'Display rooms have latest reviews', 'wp-hotel-booking' );
			parent::__construct();
		}
